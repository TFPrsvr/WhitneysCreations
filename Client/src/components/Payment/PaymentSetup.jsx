...
const PaymentSetup = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      const savedMethods = JSON.parse(
        localStorage.getItem(`printcraft_payment_methods_${user?.id}`) || "[]"
      );
  ...
  const addPaymentMethod = () => {
    ...
    localStorage.setItem(
      `printcraft_payment_methods_${user?.id}`,
  ...
  const saveBillingInfo = () => {
    ...
    localStorage.setItem(
      `printcraft_billing_info_${user?.id}`,
  ...
  const simulatePayment = (amount, planId) => {
    ...
    const confirmed = window.confirm(
      `Process payment of $${amount} for the ${planId} plan?`
    );
    if (confirmed) {
      ...
      localStorage.setItem(
        `printcraft_subscription_${user?.id}`,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tab Navigation */}
      <div
        className="flex space-x-1 bg-gray-100 rounded-lg overflow-x-auto"
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Card details are tokenized and protected
                      </div>
                    </div>
                  </div>
            ...
            {paymentMethods.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Add a credit card to get started with premium features
                </p>
                <button
                  onClick={() => setShowAddCard(true)}
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Upgrade anytime to unlock premium features and grow your
                business
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {pricingPlans.map((plan) => (
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      plan.price > 0 && simulatePayment(plan.price, plan.id)
                    }
